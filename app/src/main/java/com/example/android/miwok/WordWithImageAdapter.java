...
public class WordWithImageAdapter extends ArrayAdapter<WordWithImage> {
    private static final String LOG_TAG = Word.class.getSimpleName();


    public WordWithImageAdapter(Context context, ArrayList<WordWithImage> words) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        WordWithImage currentWord = getItem(position);
